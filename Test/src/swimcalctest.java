...
public class swimcalctest extends JFrame implements ActionListener{
	...
	public swimcalctest()
	{
	    ...
	    jtabbedPane.addTab( "General", jpGeneral );
	    jtabbedPane.addTab( "Pools", jpPools );
	    jtabbedPane.addTab( "Contractors", contractors );
	    jtabbedPane.addTab( "Customers", customers );
	    jtabbedPane.addTab( "Temp Calculator", jpTempCalc );
	    jtabbedPane.addTab( "Options", jpOptions );
	    jtabbedPane.addTab("Hot Tubs", jpHotTubs );
	    ...
	    public void createHotTubs()
	    {
	        ...
	        jpHotTubs.add(btnCalculateVlmn);       
	    }
